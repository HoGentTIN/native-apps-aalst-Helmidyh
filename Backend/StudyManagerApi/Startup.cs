...
using StudyAPI.Data;
using StudyAPI.Data.Repositories;
...
namespace StudyApi {
	public class Startup {
		...
		public void ConfigureServices(IServiceCollection services) {
            ...
            services.AddScoped<IStudieTaskRepository, StudieTaskRepository>();
            services.AddScoped<IStudieVakRepository, StudieVakRepository>();
